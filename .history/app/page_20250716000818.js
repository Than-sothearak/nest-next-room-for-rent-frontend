  ...
  if (!session) {
    ...
    return (
      ...
      <div className="w-full min-h-screen bg-white flex items-center justify-center px-6">
        <div
          className={`w-full lg:w-96 text-center transition-all duration-700 ease-out transform flex flex-col max-md:min-h-screen max-md:justify-around `}
        >
          <Image
          href="images/logo system.png"
          height={100}
          width={100}
          />
        ...
        <div className="flex gap-4 flex-col">
          ...
          <p className="text-gray-500 text-sm mb-8">
            A powerful tool to simplify how you handle bookings and manage your space. Focus on what matters, we’ll handle the rest.
          </p>
        </div>
