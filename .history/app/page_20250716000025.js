...
export default async function Home() {
  ...
  if (!session) {
    ...
    return (
      ...
      <div className="lg:container w-full min-h-screen bg-white flex flex-col items-center justify-between px-6">
        <div
          className={`w-full lg:container text-center transition-all duration-700 ease-out transform flex flex-col min-h-screen  justify-around `}
        >
