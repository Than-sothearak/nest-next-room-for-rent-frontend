...
export default async function categoryPage ({ searchParams }) {
  ...
  const categoryColumns = [
    ...
    <Link href="/dashboard/admin/categories/add" className="bg-blue-500 px-2 py-1 rounded-md hover:bg-blue-900 text-sm text-center text-secondarytext">Add new</Link>
    </div>
