...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-col p-4 gap-8 lg:h-screen w-full justify-center items-center max-md:bg-primary">
      
      <div className="bg-primary w-full m-2 sm:max-w-md max-sm:p-4 space-y-6 rounded-xl p-33 lg:shadow-lg">

        <div className="lg:text-center flex flex-col gap-10">
          <h1 className="text-2xl font-bold">Login Page</h1>
          <p>Please login to continous</p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex flex-col">
              ...
              <input
                ...
                type="email"
                name="email"
                placeholder="Enter your email provided by admin"
