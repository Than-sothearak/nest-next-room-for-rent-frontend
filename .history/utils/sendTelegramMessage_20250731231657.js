...
<p>Dear</p> <b>${customer}</b>,
<p>Please find the attached invoice on</p> <b>${formatDate(startDate)} – ${formatDate(dueDate)}</b>
<p>Kindly review and complete the payment at your earliest convenience.</p>
<p>Thank you.</p>
<p>Best regards,</p>
    `.trim();
