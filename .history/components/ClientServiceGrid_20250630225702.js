        ...
        {types.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              {isPending && (
                <form className="absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2 bg-white items-center justify-center text-black px-2 py-1 rounded-md z-0">
                  <div>
                     <p className="top-1 left-2 text-sm">
