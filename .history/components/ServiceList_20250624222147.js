                        ...
                        <td className={``}><p className="bg-amber-200 w-max px-4 rounded-full text-amber-700">Padding</p></td>
                         <td className="">
                            <div className="flex gap-2">
                                <button className="bg-green-400 px-4 rounded-full text-green-700">Accept</button>
                                <button className="bg-green-400 px-4 rounded-full text-green-700">Cancel</button>
                            </div>
                         </td>
                    </tr>
