      ...
      <div className="mt-4 w-1/2 max-lg:w-full justify-start items-start flex gap-4 p-4 bg-primary rounded-lg ">
        <div className="flex flex-col w-full">
          ...
          <div className='w-full mt-2'>
            {booking.userId?.telegramChatId ? <Link href={`https://t.me/wbc_notifications_bot?start=${booking?.userId?._id}`} className='flex items-center gap-1 border w-max p-2 rounded-md bg-blue'>
