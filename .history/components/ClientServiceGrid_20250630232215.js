  ...
  return (
    <div className="mt-4 relative">
                ...
                <form className="absolute bg-white w-full h-full items-center justify-center text-black px-4 py-2 rounded-md z-0">
                  ...
                  <div className="">
                    ...
                    <div>
                      ...
                      <div className="flex flex-col justify-center text-xs items-center gap-2">
                        <div>
                          {item.icon}
                        </div>
     ...
     <div className="w-full">
                      ...
                      {services
                        .some((s) => s.serviceType === item.service)
                        .map((service) => (
                          <button
                            key={service._id}
                            onClick={() => handleAction(service._id)}
                            type="button"
                            className="bottom-2 bg-blue-500 p-2 rounded-md right-2 text-primary hover:bg-blue-700"
                          >
                            Cancel
                          </button>
                        ))}
        ...
        <div className="flex items-center w-full max-w-2xl justify-between relative">
          {/* Progress line */}
          <div className="absolute top-2 left-0 w-full h-1 bg-gray-300 z-0 transform -translate-y-1/2"></div>
          ...
          {["Requested", "Accepted", "Completed"].map((step, index) => {
            ...
            return (
              <div key={step} className="relative z-10 flex flex-col items-center w-4">
                <div className={`justify-between flex items-center w-4 h-4 rounded-full 
