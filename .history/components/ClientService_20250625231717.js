  ...
  return (
    ...
    <p className="text-lg font-bold">Accepted</p>
     ...
     <button className="w-full justify-center items-center flex gap-4 p-4 bg-blue-500 text-primary hover:bg-blue-700 rounded-lg ">
          ...
          {isClicked && 
          <div className='absolute z-30 top-1 left-1/2 overflow-y-auto p-4 bg-white rounded-lg max-lg:w-full w-1/2 -translate-x-1/2 -translate-y-1/2 lg:-translate-y-1/3 shadow-xl'>
