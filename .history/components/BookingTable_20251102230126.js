...
const BookingTable = ({
      ...
      <div className=" overflow-x-auto pb-10">
        ...
        <thead className="bg-primary text-tertiary">
          <tr className="bg-gray-100 text-left">
            ...
            <th className="px-2 text-center whitespace-nowrap"> Download</th>
  ...
  <Link
    ...
    title="Print invoice"
    className="inline-flex items-center justify-center gap-1 px-3 py-1 rounded-md bg-blue-600 text-white hover:bg-blue-300 hover:text-blue-900 transition-all duration-200"
  >
    <BiPrinter size={18} />
