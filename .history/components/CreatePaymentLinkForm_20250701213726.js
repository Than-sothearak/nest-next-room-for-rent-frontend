...
setLoading(false)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 relative">
      ...
      {response && isClicked && (
      <div className={`${isClicked ? 'opacity-100 translate-x-1/2 ': 'translate-x-1'} w-full absolute bg-white -top-96 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 p-4 rounded-xl shadow-lg`}>
