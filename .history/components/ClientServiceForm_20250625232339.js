...
const ClientServiceForm = ({ serviceType, user }) => {
  const [startDate, setStartDate] = useState("")
  const [service, setService] = useState("" || serviceType)
   const [startTime, setStartTime] = useState("")
   const [note, setNote] = useState("")
   const handleAddRequest = requestService.bind(null, user._id)
 const [state, action, isPending] = useActionState(handleAddRequest = r, undefined)
  return (
