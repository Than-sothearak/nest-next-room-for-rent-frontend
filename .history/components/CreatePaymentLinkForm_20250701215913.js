  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {response && (
        ...
        <div className={`fixed z-50 ${isClicked ? 'opacity-100 -translate-y-1/2' : 'opacity-0'} bg-white -top-96 left-1/2 -translate-x-1/2  transition-all duration-300 p-4 rounded-xl shadow-lg`}>
