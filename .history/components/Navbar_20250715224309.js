...
export const Navbar = ({ session, user, navigation}) => {
  ...
  return (
    <div className="bg-primary py-4 px-4 w-full max-sm:block flex justify-between items-center sticky top-0 z-30">
      <div className="max-sm:mb-2 flex gap-4 items-center">
        ...
        <div className="capitalize text-sm text-primarytext flex gap-1 items-center bg-black overflow-x-hidden">
