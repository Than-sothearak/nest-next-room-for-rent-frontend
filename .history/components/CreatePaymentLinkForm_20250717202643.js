...
<Image
      ...
      {response && (
        <div className="">
          ...
          ></div>
          <div
            className={`fixed w-full m-4 translate-y-0 opacity-0 border-2 ${
              isClicked ? "inset-x-40 opacity-100" : "hidden"
            } bg-white top-1/4 left-1/2 -translate-x-1/2  w-96 transition-all duration-300 p-4 rounded-xl shadow-lg  max-h-screen max-sm:top-2 z-50 justify-center flex flex-col items-center`}
          >
