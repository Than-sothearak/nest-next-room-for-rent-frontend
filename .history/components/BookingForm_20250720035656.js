...
export default function BookingForm({
  ...
  const [parking, setParking] = useState(booking?.parking.parking || null)
  const [qty, setQty] = useState(booking?.parking.size || null)
        ...
        <div className="p-4 bg-primary rounded-xl">
          ...
          <div className="w-full flex  items-center gap-4">
           <div className="flex flex-col">
            ...
            <select className="border rounded p-2" name="parking" value={parking}>
