...
import { BiCloset, BiPencil } from "react-icons/bi";
  ...
  return (
    <div className="">
      ...
      {editClicked && (
           ...
           <div className="h-full w-full absolute bg-white shadow-lg p-4 border rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            <button className="flex justify-end text-end"><CgClose /></button>
             <input
              ref={fileInputRef}
