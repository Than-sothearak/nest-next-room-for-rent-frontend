    ...
    <div className="">
      ...
      >
        ...
        {/* {files.length <= 0 && <h1 className="text-slate-300 text-md">Upload image</h1>} */}
         ...
         {files.length > 0 && (
          <div className="overflow-y-scroll flex flex-wrap justify-start gap-4 border-dashed border-secondary mt-2 rounded-md border-2 p-2 w-full">
            {files.map((fileData, index) => (
              ...
              >
                {fileData.file.type.startsWith("image/") ? (
                  <div className="w-full border flex items-center gap-2 border-secondary rounded-sm max-sm:w-full ">
                   <div className="w-10 h-10">
                     <Image
                      ...
                      alt="Preview"
                      className="p-2 w-full h-full rounsded-md  object-cover transition-opacity duration-300 group-hover:opacity-10"
                    />
                   </div>
