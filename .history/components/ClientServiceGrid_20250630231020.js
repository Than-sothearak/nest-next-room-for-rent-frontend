...
<div className="flex items-center w-full max-w-2xl justify-between relative">
    {/* Progress line */}
    <div className="absolute top-1 left-0 w-full h-1 bg-gray-300 z-0 transform -translate-y-1/2"></div>
    ...
    {["Requested", "Accepted", "Completed"].map((step, index) => {
      ...
      return (
        <div key={step} className="relative z-10 flex flex-col items-center w-1">
