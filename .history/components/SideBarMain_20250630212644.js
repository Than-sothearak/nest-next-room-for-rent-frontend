          ...
          <div className="bg-slate-100 shadow-lg border border-slate-300 rounded-lg p-4 absolute top-1 left-0 w-full max-w-xs z-50">
            ...
            <div className="flex flex-col items-center gap-4 pt-4">
              ...
              <Link
                ...
                className="bg-slate-200 hover:bg-slate-300  w-full text-center flex gap-2 justify-start items-center border border-slate-300 p-4 rounded-xl cursor-pointer"
              >
