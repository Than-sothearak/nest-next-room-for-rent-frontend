          ...
          <table className="min-w-[800px] w-full table-auto border rounded-lg shadow">
            <thead className="bg-gray-100 text-left text-sm">
              <tr className="p-4 border-b">
                ...
                <th className="text-start p-2 whitespace-nowrap inline-flex items-center gap-1 hover:underline">Room</th>
                <th className="text-start p-2 whitespace-nowrap inline-flex items-center gap-1 hover:underline">Guest</th>
                <th className="text-start p-2 whitespace-nowrap inline-flex items-center gap-1 hover:underline">
                  Requesting
                </th>
