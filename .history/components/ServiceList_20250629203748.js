                      ...
                      <div className="flex gap-2">
                        <div className="flex gap-2 flex-wrap py-1">
                          <button
                            ...
                            type="button"
                            className={` px-4 rounded-full text-white ${isLoading ? 'bg-green-400 opacity-50 cursor-wait' : 'bg-green-400'}`}
                          >
                            Accept
                          </button>
                          <button
                            ...
                            type="button"
                            className={` px-4 rounded-full text-white ${isLoading ? 'bg-red-400 opacity-50 cursor-wait' : 'bg-red-400'}`}
                          >
                            Cancel
                          </button>
                        </div>
