  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {response && (
        ...
        <div className={`${isClicked ? 'fixed inset-0 ' : 'opacity-0'} bg-white top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 p-4 rounded-xl shadow-lg`}>
