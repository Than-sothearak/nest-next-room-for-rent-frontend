...
export const ClientDashboard = ({ booking, payments, user }) => {
  ...
  return (
    <div>
      ...
      <ClientService isClicked={isClicked} setIsClicked={setIsClicked}/>
      ...
      {isClicked && <div className='absolute top-1/2 left-1/2 overflow-y-auto p-4 bg-black/50 h-screen w-full -translate-x-1/2 -translate-y-1/2 shadow-xl'>
