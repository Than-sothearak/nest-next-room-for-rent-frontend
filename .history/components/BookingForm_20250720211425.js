  ...
  return (
    ...
    >
      {state?.success && (
        ...
        <div className="bg-red-300 flex items-center justify-center fixed p-10 top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-md">
...
Booking added successfully!
            ...
            <button className="bg-blue-500 p-2">Ok</button>
          </div>
        </div>
