...
export default function BookingForm({
  ...
  return (
    ...
    >
     ...
     <div>
      <div className="bg-black/50 w-full h-full fixed">
...
Booking added successfully!
            ...
            <div className="flex justify-between gap-2"><button type="button" className="bg-blue-500 p-2 rounded-md text-primary w-full">Stay</button>
            <button type="button" className="w-full bg-blue-500 p-2 rounded-md text-primary whitespace-nowrap">Go to Booking</button></div>
          </div>
        </div>
     </div>
