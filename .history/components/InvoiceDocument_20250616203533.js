    ...
    <Document>
      <Page style={styles.page} size="A4">
        ...
        <View style={styles.header}>
          <Image style={styles.logo} src="http://localhost:3000/_next/image?url=https%3A%2F%2Fthearak-next-computer.s3.ap-southeast-1.amazonaws.com%2F1747122537315-maxresdefault.jpg&w=128&q=75" />
          <View>
