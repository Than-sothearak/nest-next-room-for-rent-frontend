...
<Image
      ...
      {response && (
        <div className="">
          ...
          ></div>
          <div
            className={`fixed w-96 translate-y-0 opacity-0 border-2 inset-4 ${
              isClicked ? "opacity-100" : "hidden"
            } bg-white top-1/4 left-1/2 -translate-x-1/2  transition-all duration-300 p-4 rounded-xl shadow-lg  max-h-screen  z-50 justify-center flex flex-col items-center`}
          >
