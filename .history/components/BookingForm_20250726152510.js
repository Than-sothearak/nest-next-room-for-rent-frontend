    ...
    <div>
      ...
      >
        ...
        <div className="space-y-4 bg-white shadow  p-4  rounded-xl">
          ...
          <div className="grid gap-2">
            <label className="font-bold">Contract    {state?.errors?.roomId && (
              <p className="text-red-500">{state.errors.contract}dsd</p>
            )} <span className="font-normal">(required)</span></label>
            <select
              name="contract"
              value={contract}
