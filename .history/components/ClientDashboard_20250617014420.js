      ...
      <div className="mt-4 w-1/2 max-lg:w-full justify-start items-start flex gap-4 p-4 bg-primary rounded-lg ">
        ...
        <div className='bg-slate-100 p-2 mt-2'>
          <div className='flex items-center justify-between font-bold'>
            <p>Recipts: {formatDate(payments[0].startDate)} - {formatDate(payments[0].dueDate)} </p>
            ...
            <div className='flex items-center justify-between'>
              <p>Paid at</p> <p>{formatDate(payments[0].paidAt)}</p>
            </div>

             <div className='flex items-center justify-between'>
              <p>Consumer</p> <p>{payments[0].userId.username}</p>
            </div>

            <div className='flex items-center justify-between'>
              <p>Amount</p> <p>{payments[0].amount}</p>
            </div>
        </div>
        </div>
    </div>
