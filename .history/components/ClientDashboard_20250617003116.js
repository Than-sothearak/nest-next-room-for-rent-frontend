      ...
      <div className="mt-4 rounded-lg flex max-sm:flex-wrap gap-4">
       ...
       <div className="mt-4 w-full justify-start items-start flex gap-4 p-4 bg-primary rounded-lg ">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className='flex'><IoDiceOutline /> <p className='bg-slate-200 px-2 rounded-sm uppercase'> {booking.userId._id.slice(-10)}</p></div>
            <div className='flex'><PiPhoneBold size={28}/> <p className='bg-slate-200 px-2 rounded-sm uppercase'> {booking.userId._id.slice(-10)}</p></div>
            <p className="text-green-500 text-xs">
              12% <span className="text-primarytext">more than previus week</span>
            </p>
          </div>
