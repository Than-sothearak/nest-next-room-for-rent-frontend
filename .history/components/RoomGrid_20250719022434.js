  ...
  return (
    <div className="my-4">
      <div className="w-full flex justify-between items-center my-4">
        <h1 className="h-10 text-center text-2xl font-bold">Room List</h1>
        <div className="flex items-center gap-2">
          <label htmlFor="sort" className="text-sm font-medium text-gray-700 whitespace-nowrap">Sort by</label>
          <select
            id="sort"
            name="sort"
            className="flex gap-2 w-full px-3 py-1 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-700"
            defaultValue="date"
          >
            <option value="date" handleChange={handleChangeSort}>Date</option>
            <option value="status" handleChange={handleChangeSort}>Status</option>
          </select>
        </div>
