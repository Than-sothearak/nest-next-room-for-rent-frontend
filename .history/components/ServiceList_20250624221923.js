        ...
        <div className="w-full h-full mt-4">
            ...
            <table className="w-full bg-slate-500 max-lg:hidden">
                <thead className="bg-primary text-tertiary">
                    <tr className="p-4">
                        <th className="text-start py-4 w-full">No</th>
                        <th className="text-start w-full">Room</th>
                        <th className="text-start w-full">Guest</th>
                        <th className="text-start w-full">Status</th>

                        <th className="text-start w-full">Action</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    >
                        ...
                        <td className="p-2 font-bold">086643205</td>
