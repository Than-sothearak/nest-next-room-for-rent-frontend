        ...
        {types.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 w-full h-[96px] -translate-x-1/2 -translate-y-1/2 bg-white/80 hover:opacity-100 opacity-0 flex items-center justify-center text-black px-2 py-1 rounded-md ">
                <button
                  value={item.service}
                  onClick={(e) =>
