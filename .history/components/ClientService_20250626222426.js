              ...
              {isAccepted && (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-1">
                   ...
                   <p className="absolute top-1 left-2 text-xs">{formatDateOnly(services.filter(service => service.serviceType === item.service && service.status === 'accepted')[0].startDate) + '-' + services.filter(service => service.serviceType === item.service && service.status === 'accepted')[0].startTime}</p>
