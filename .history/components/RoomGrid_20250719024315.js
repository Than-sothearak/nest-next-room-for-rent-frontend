      ...
      <div className="w-full flex justify-between items-center my-4 gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            id="sort"
            name="sort"
            className="mt-10 flex gap-2 w-full px-3 py-1 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-700"
            defaultValue="date"
          >
