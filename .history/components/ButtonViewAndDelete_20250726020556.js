...
const ButtonViewAndDelete = ({
  ...
  const [state, formAction, isPending] = useActionState( initialState, deleteById(id) );
              ...
              <div className="w-full flex justify-between gap-4">
                ...
                <form action={deleteUserById.bind(null, id)} className="w-full">
                  <button
                    ...
                    className={`${pending ? 'bg-black' : ''} rounded-md bg-red-500 px-4 py-2 text-white w-full hover:bg-red-700`}
                  >
                    Yes
                  </button>
                </form>
