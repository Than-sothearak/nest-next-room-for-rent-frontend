            ...
            >
                ...
                <div className="w-full">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="font-bold w-full p-2 rounded-md text-lg focus:ring-0 focus:outline-none bg-tertiary text-primary"
              ...
              <div className="w-full mt-4 flex items-center">
                ...
                <input
                  ...
                  className="p-2 rounded-md text-xs focus:ring-0 focus:outline-none border border-secondary"
