...
console.log(user)
  return (
    <div className={`${user.telegramChatId ? 'bg-green-300' : 'bg-slate-200 hover:bg-slate-300'} cursor-pointer flex flex-col items-center justify-center p-4  w-full border border-slate-300 rounded-xl`}>
