...
setLoading(false)
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 relative">
      ...
      {response && (
      <div className="absolute bg-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 p-4 rounded-xl shadow-lg">
          <div className="mt-4">
    ...
    <img src={response.result.qrImage}/>
      ...
      <div className="absolute bg-black/50 z-50 w-full h-full top-0">
