...
const ButtonViewAndDelete = ({ link, id, setOptimisticData,pending, session }) => {
  ...
  return (
    ...
    >
      ...
      {/* Dropdown menu */}
      <div
        className={`absolute bg-primary border border-secondary shadow-sm p-2 flex gap-2 justify-items-center items-center rounded-md transition-opacity duration-200 ease-out z-10 left-0 top-4 max-md:left-0 ${
