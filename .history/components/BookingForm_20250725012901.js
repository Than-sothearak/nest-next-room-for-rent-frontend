  ...
  return (
    ...
    >
        ...
        <div>
          ...
          <div className="bg-primary z-50 border shadow-md flex items-center justify-center fixed px-10 py-4 top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2 rounded-md">
            <div className="flex gap-4 flex-col justify-center w-full">
              <p className="w-full text-green-500 text-center">

                {state?.message}
              </p>
              <div className="flex justify-between gap-2"><button type="button" onClick={handleCLose} className="bg-blue-500 p-2 rounded-md text-primary w-full">Ok</button>
