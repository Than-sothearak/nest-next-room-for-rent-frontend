          ...
          <div className="w-full md:w-2/3 space-y-6">
            <div className="text-xs grid grid-cols-1 gap-6 sm:grid-cols-2">
             ...
             {session.user.isAdmin ?  <div>
                ...
                className="bg-secondary hiiden border w-full border-secondary  px-4 py-2.5 rounded-lg transition-all appearance-none bg-transparent outline-none focus:ring-2 focus:border-none"
              />}
            </div>
