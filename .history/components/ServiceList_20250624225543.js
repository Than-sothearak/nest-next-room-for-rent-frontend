                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td className="">
                                ...
                                <div className="flex gap-2">
                                    <button className="bg-green-400 px-4 rounded-full text-white">Mark as completed</button>
                                </div>
                ...
                <table className="w-full bg-slate-500 max-lg:hidden">
                    ...
                    <tbody>
                        ...
                        <tr
                            ...
                            className=" odd:bg-green-100 even:bg-gray-100 text-gray-900 dark:odd:bg-slate-200 dark:even:bg-gray-100 dark:text-tertiary"
                        >
                            <td className="p-2">
                                <p>1</p>
                            </td>
                            ...
                            <td className="font-bold">086643205</td>
                            <td className="font-bold">Cleaning room</td>
                            <td className={``}><p className="bg-green-200 w-max px-4 rounded-full text-green-700">Completed</p></td>
                            <td>12-07-2025 12:00</td>
                            <td className="">
