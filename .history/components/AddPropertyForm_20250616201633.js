                ...
                <div className="flex w-full">
                  ...
                  <div className="mt-2">
                    <input
                      ...
                      className="font-bold w-full p-2 rounded-md text-xs focus:ring-0 focus:outline-none bg-tertiary text-primary"
                      placeholder="Enter service name (e.g., Cleaning)"
                    />
                  </div>
                </div>
              </div>
              <div className="w-full mt-4">
                <label className="w-full block font-medium">Price USD</label>
                <input
                  type="text"
                  name="price"
                  required
                  ...
                  className="w-full p-2 rounded-md text-xs focus:ring-0 focus:outline-none border border-secondary"
