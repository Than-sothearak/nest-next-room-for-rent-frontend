    ...
    <form onSubmit={handleSubmit} className="space-y-2">
     <div className="flex flex-col gap-2 ">
      ...
      <div className="border rounded-xl p-2">
        <button type="submit" className="hover:bg-slate-100 justify-center items-center text-slate-800 px-4 py-2 rounded flex gap-6" disabled={loading}>
        <div className="">
          <Image src={'/images/khqr.jpg'} width={50} height={100} alt="logo">
