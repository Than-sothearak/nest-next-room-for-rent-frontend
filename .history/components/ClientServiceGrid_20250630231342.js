      ...
      <div className="mt-4 rounded-lg grid grid-cols-2 md:grid-cols-4 gap-4">
        {types.map((item, index) => {
          ...
          return (
                ...
                <form className="absolute bg-white w-full h-full items-center justify-center text-black px-4 py-2 rounded-md z-0">
                  ...
                  <div className="flex flex-col">
                    <div>
                      ...
                      <div className="flex items-center w-64 max-w-2xl justify-between relative">
                        {/* Progress line */}
            ...
            ${isPending ? "bg-green-500 text-white" : isActive ? "bg-blue-500 text-white" : "bg-gray-300 text-gray-600"}`}>
                              </div>
