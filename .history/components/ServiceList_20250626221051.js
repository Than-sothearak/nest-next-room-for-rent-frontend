    ...
    <div className="w-full h-full mt-4">
          ...
          <tbody>
            {services?.map((service, index) => (
              ...
              >
                ...
                <td className="font-bold">{service.status === 'cancelled' ? service.startTime : formatDateOnly(service.startDate)+ "-Time: " + formatTo12Hour(service.startTime) }</td>
                <td className="">
      ...
      {isClick === "Processing" && (
        <table className="w-full bg-slate-500 max-lg:hidden">
          ...
          <tbody>
            <tr className=" odd:bg-white even:bg-gray-100 text-gray-900 dark:odd:bg-slate-200 dark:even:bg-gray-100 dark:text-tertiary">
              <td className="p-2">
                <p>1</p>
              </td>
              ...
              <td className={``}>
                <p className="bg-amber-200 w-max px-4 rounded-full text-amber-700">
                  in-progress
                </p>
              </td>
              ...
              <td className="">
                <div className="flex gap-2">
                  <button className="bg-green-400 px-4 rounded-full text-white">
                    Mark as completed
                  </button>
                </div>
              </td>
