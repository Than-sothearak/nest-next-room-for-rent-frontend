...
const SideBarMain = ({ handleClick, isOpen, session, currentUser, navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className=" bg-slate-100 shadow-lg w-full border p-4 mt-2 rounded-lg border-secondary shadow-xl/20">
          <button
      ...
      <SidebarList navList={navigation} handleClick={handleClick}/>
