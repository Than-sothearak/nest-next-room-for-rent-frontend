...
export const RoomGrid = ({ data, session }) => {
  ...
  <select
    id="sort"
    name="sort"
    className="block w-full px-3  border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-700"
    defaultValue="date"
  >
